# 消えた灯台守 v2.16.1 [assistant-key-foreshadowing]
...
```scenario-json
{
  ...
  "locations": [
    ...
    },
    {
      ...
      "intro": "灯台の重い扉は不自然に半開きになっている。扉や錠前に壊された形跡はなく、誰かが鍵を使って開けたようにも見える。床には赤黒い染みがこびりついている。灯台助手のレナは扉のそばに立ち、腰の鍵束を気にするような仕草を見せている。",
      "banter_observation": "灯台入口では扉が半開きで、錠前に壊された形跡はない。レナは鍵束を気にするような仕草を見せている。",
      "surface_banter_observation": "灯台入口の扉は半開きだが、扉や錠前に壊された形跡はない。レナは腰の鍵束を気にするような仕草を見せている。",
      "npcs": [
        "assistant"
      ],
      "visible_objects": [
  ...
  "npcs": [
    ...
    },
    {
      ...
      "banter_observation": "灯台助手レナは扉のそばに立ち、腰の鍵束を気にするような仕草を見せている。こちらに気づくと、鍵束を握ったまま口を閉ざす。",
      "surface_banter_observation": "灯台助手レナは扉のそばに立ち、腰の鍵束を気にするような仕草を見せている。",
  ...
  "tests": {
    ...
    "natural_name_routing": {
      "commands": [
        "村長にユアンのことを聞く"
      ],
      "expect": [
        "発見: 村長は、灯台の灯が消える直前に港の倉庫で人影を見たと話した。"
      ],
      "expect_not": [
        "詳しいことを知らない"
      ]
